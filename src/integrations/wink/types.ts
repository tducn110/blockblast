/**
 * Shared types for the Block Blast Wink integration.
 * Ported verbatim from the certified FruitSlashing reference
 * (bo-lac-fruit-slashing-pixijs) so client.ts stays a straight copy too.
 *
 * Block-Blast-specific shapes (WinkRound, the round-aware integration handle)
 * live in useWinkIntegration.ts and deliberately do not belong here.
 */
