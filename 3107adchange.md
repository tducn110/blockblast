diff --git a/PLANAD.md b/PLANAD.md
new file mode 100644
index 0000000..af503ef
--- /dev/null
+++ b/PLANAD.md
@@ -0,0 +1,164 @@
...
-      gameThemes.ts
-      Mascot.tsx
-      PixiBlockBlastCanvas.tsx
-      SlashScoreOverlay.tsx
-    game/
-      blockBlastLogic.ts
-      localStats.ts
-      pixiDrawUtils.ts
-    hooks/
-      useBlockBlastGame.ts
-      useScoreData.ts
-    lib/
-      dashboardHelpers.ts
-      gameText.ts
...
-</file>
-
-<file path="components/background/CountrysideBackdrop.tsx">
...
-</file>
-
-<file path="components/ui/LogoBubble.tsx">
...
-</file>
-
-<file path="features/blockblast/audio/blockBlastAudio.ts">
-type ToneOptions = {
...
-</file>
-
-<file path="features/blockblast/components/Game.tsx">
-import { useEffect, useRef } from "react";
...
-</file>
-
-<file path="features/blockblast/components/GameHUD.tsx">
...
-</file>
-
-<file path="features/blockblast/components/gameThemes.ts">
...
-  peanut: "rgba(200,146,12,0.5)",
-  bamboo: "rgba(76,102,48,0.5)",
-  orange: "rgba(184,90,34,0.5)",
-  brown: "rgba(90,48,16,0.5)",
-  cream: "rgba(142,110,58,0.5)",
-};
-</file>
-
-<file path="features/blockblast/components/Mascot.tsx">
-import { useEffect, useRef } from "react";
-import gsap from "gsap";
-
...
-</file>
-
-<file path="features/blockblast/components/PixiBlockBlastCanvas.tsx">
...
-</file>
-
-<file path="features/blockblast/components/SlashScoreOverlay.tsx">
...
-</file>
-
-<file path="features/blockblast/game/blockBlastLogic.ts">
...
-</file>
-
-<file path="features/blockblast/game/localStats.ts">
...
-</file>
-
-<file path="features/blockblast/game/pixiDrawUtils.ts">
...
-</file>
-
-<file path="features/blockblast/hooks/useBlockBlastGame.ts">
...
-</file>
-
-<file path="features/blockblast/hooks/useScoreData.ts">
...
-</file>
-
-<file path="features/blockblast/lib/dashboardHelpers.ts">
-import type { LocalStats } from "@/features/blockblast/game/localStats";
-
...
-</file>
-
-<file path="features/blockblast/lib/gameText.ts">
...
-</file>
-
-<file path="features/blockblast/lib/localScores.ts">
-import {
-  createDefaultStats,
-  loadStats,
-  saveStats,
...
-</file>
-
-<file path="features/blockblast/render/usePixiAnimations.ts">
-import { useEffect, useRef } from "react";
...
-</file>
-
-<file path="features/blockblast/render/usePixiApp.ts">
...
-</file>
-
-<file path="features/blockblast/render/usePixiBoard.ts">
-import { useEffect, useRef } from "react";
...
-</file>
-
-<file path="features/blockblast/render/usePixiPieces.ts">
-import { useEffect, useRef } from "react";
...
-</file>
-
-<file path="features/blockblast/screens/Dashboard.tsx">
...
-</file>
-
-<file path="features/blockblast/screens/Settings.tsx">
...
-
-</files>
diff --git a/report3006.md b/report3006.md
new file mode 100644
index 0000000..a1146b3
--- /dev/null
+++ b/report3006.md
@@ -0,0 +1,531 @@
...
+```
diff --git a/src/features/blockblast/components/Game.tsx b/src/features/blockblast/components/Game.tsx
index 51825a5..9aa64cb 100644
--- a/src/features/blockblast/components/Game.tsx
+++ b/src/features/blockblast/components/Game.tsx
@@ -1,4 +1,4 @@
-import { useEffect, useRef } from "react";
+import { useCallback, useEffect, useRef, useState } from "react";
 import { Trophy, RotateCcw, Settings } from "lucide-react";
...
+            onUseReserveSlot={game.useReserveSlot}
           ...
           <SlashScoreOverlay items={game.feedback} />
@@ -155,3 +245,63 @@ export function Game({
     </section>
   );
 }
+
...
+  );
+}
diff --git a/src/features/blockblast/components/GameHUD.tsx b/src/features/blockblast/components/GameHUD.tsx
index 1083507..3bcc0ba 100644
--- a/src/features/blockblast/components/GameHUD.tsx
+++ b/src/features/blockblast/components/GameHUD.tsx
...
+          textShadow: accent ? "0 1px 0 rgba(255,250,240,0.8)" : "none",
       ...
       >
         {value}
diff --git a/src/features/blockblast/components/PixiBlockBlastCanvas.tsx b/src/features/blockblast/components/PixiBlockBlastCanvas.tsx
index 5477c16..934790e 100644
--- a/src/features/blockblast/components/PixiBlockBlastCanvas.tsx
+++ b/src/features/blockblast/components/PixiBlockBlastCanvas.tsx
...
diff --git a/src/features/blockblast/hooks/useBlockBlastGame.ts b/src/features/blockblast/hooks/useBlockBlastGame.ts
index e258af9..7b5803a 100644
--- a/src/features/blockblast/hooks/useBlockBlastGame.ts
+++ b/src/features/blockblast/hooks/useBlockBlastGame.ts
...
+    useReserveSlot,
     ...
     toggleMusic,
     dismissFeedback,
diff --git a/src/features/blockblast/render/usePixiPieces.ts b/src/features/blockblast/render/usePixiPieces.ts
index 5ef4ce4..5112e20 100644
--- a/src/features/blockblast/render/usePixiPieces.ts
+++ b/src/features/blockblast/render/usePixiPieces.ts
@@ -1,8 +1,9 @@
 import { useEffect, useRef } from "react";
...
+  VIEW_WIDTH,
   ...
   TRAY_Y,
   TRAY_X,
@@ -22,9 +23,65 @@ interface SlotObjects {
   shell: Graphics;
   pieceGraphic: Container; // Changed to Container containing Sprites
   mark: Graphics;
+  label: Text;
